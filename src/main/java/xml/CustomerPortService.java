 ...
 * 
 */
@WebServiceClient(name = "CustomerPortService", targetNamespace = "http://luizmarcelo.com/customersadministration/customers", wsdlLocation = "http://localhost:8080/ws/customers.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERPORTSERVICE_QNAME = new QName("http://luizmarcelo.com/customersadministration/customers", "CustomerPortService");
    ...
    public CustomerPort getCustomerPortSoap11() {
        return super.getPort(new QName("http://luizmarcelo.com/customersadministration/customers", "CustomerPortSoap11"), CustomerPort.class);
    }
    ...
    public CustomerPort getCustomerPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://luizmarcelo.com/customersadministration/customers", "CustomerPortSoap11"), CustomerPort.class, features);
    }
